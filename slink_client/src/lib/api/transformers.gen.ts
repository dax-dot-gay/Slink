...
import type { GetIndexResponse, ListMinecraftVersionsResponse, GetLatestReleaseVersionResponse, GetLatestSnapshotVersionResponse, GetSpecificVersionResponse } from './types.gen';
