...
import type { GetIndexResponse, GetOwnedServersResponse, CreateServerResponse, ListMinecraftVersionsResponse, GetLatestReleaseVersionResponse, GetLatestSnapshotVersionResponse, GetSpecificVersionResponse, GetVersionMetadataResponse } from './types.gen';
...
const minecraftServerSchemaResponseTransformer = (data: any) => {
    data.minecraft_version = minecraftVersionMetadataSchemaResponseTransformer(data.minecraft_version);
    return data;
};

export const getOwnedServersResponseTransformer = async (data: any): Promise<GetOwnedServersResponse> => {
    data = data.map((item: any) => {
        return minecraftServerSchemaResponseTransformer(item);
    });
    return data;
};

export const createServerResponseTransformer = async (data: any): Promise<CreateServerResponse> => {
    data = minecraftServerSchemaResponseTransformer(data);
    return data;
};
